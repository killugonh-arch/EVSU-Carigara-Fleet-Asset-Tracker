...
urlpatterns = [
    ...
    path('assets/<int:pk>/request-use/',   views.asset_usage_request,      name='asset_usage_request'),
    path('asset-usage-requests/',          views.asset_usage_request_list, name='asset_usage_request_list'),
    path('asset-usage-requests/<int:pk>/approve/', views.asset_usage_approve, name='asset_usage_approve'),
    path('asset-usage-requests/<int:pk>/reject/',  views.asset_usage_reject,  name='asset_usage_reject'),
    path('asset-usage-requests/<int:pk>/release/', views.asset_usage_release, name='asset_usage_release'),
    ...
    path('mileage-logs/',                 views.mileage_log_list,       name='mileage_log_list'),
    path('mileage-logs/<int:pk>/review/', views.mileage_log_review,     name='mileage_log_review'),
    # Asset Requests
    ...
    # Admin History
    path('history/asset-requests/',       views.admin_asset_request_history,       name='admin_asset_request_history'),
    path('history/maintenance-requests/', views.admin_maintenance_request_history, name='admin_maintenance_request_history'),
